...
3. Projeto 9: Navegação entre Telas
  ...
  • Navegação de Abas (Tabs): Estrutura de navegação principal contendo telas.
  
  • Navegação Programática: Uso de hooks e propriedades para transitar entre telas via código
  
  • Customização de UI: Desativação de cabeçalhos nativos para uma interface mais limpa e moderna.
